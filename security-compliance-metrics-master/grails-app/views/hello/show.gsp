...
<html>
	...
	<body>
		...
		<div id="show-hello" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:helloInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${helloInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
